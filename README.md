# mobile Webapps with ionic and yaga

This presentation is about building apps for spatial data and should be
presented on the
[FOSSGIS Conference 2016](http://www.fossgis-konferenz.de/2016/).

## Start presentation

### Prerequirements

* You must have an installed version of [node.js](https://nodejs.org/)
* You must have an installed version of [Grunt](http://gruntjs.com/)
* You must install node dependencies with: `npm install` within the root
folder

### Run presentation

Type the following command into your terminal, a browser window should
...
*The following information is from and about the presentation framework
reveal.js*
